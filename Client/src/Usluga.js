export class Usluga {
    constructor(id, naziv = "", cena = 0, kategorija = -1, kolicina = 0, brojIzabranih = 0, opis = "") {
        this.id = id;
        this.naziv = naziv;
        this.cena = cena;
    ...
    prikaziUslugu(saKontrolama = true, naKlik = undefined, lista) {
        ...
        if (saKontrolama) {
            ...
            dugmeUkloni.className = "ukloni_uslugu";
            ...
            dugmeUkloni.addEventListener("click", event => {
                ...
                lista.posaoForma.ukloniUsluguIzPosla(this);
        ...
        if (saKontrolama) {
            ...
            stavkaListe.title = "Kliknite na naziv usluge za detalje";
        }
        ...
        if (saKontrolama) {
            ...
            dugmeDodaj.className = "dodaj_uslugu";
            ...
            dugmeDodaj.addEventListener("click", event => {
                ...
                lista.posaoForma.dodajUsluguUPosao(this);
            });
    ...
    prikaziUsluguShort(lista) {
        let stavkaListe = document.createElement("li");
            stavkaListe.className = "stavka_menija";
            lista.naruceneContainer.appendChild(stavkaListe);
